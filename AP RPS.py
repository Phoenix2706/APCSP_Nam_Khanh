import random
# import the function "random" to use when deciding computer's hand
...
def play_game():
    ...
    # values rock, paper, or scissors is chosen at random to determine computer's hand
...
def show_result(user_input, computer_input):
    ...
    return winner
# the returned "winner" value is used to determine which side the score should be given to.


print("Hello and welcome to Rock, Paper, Scissors!")
user_name = input("Please enter your username: (example: Khanh) ").upper()
play_count_request = int(input("Alright " + user_name + "! How many times would you like to play? "))
